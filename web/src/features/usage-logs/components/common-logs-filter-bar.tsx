...
export function CommonLogsFilterBar<TData>(
  ...
  // 1. 直接在 sensitiveToggle 中同時包入「導出 Excel」與「眼睛」按鈕
  const sensitiveToggle = (
    <div className="flex items-center gap-1.5">
      <Tooltip>
            ...
            <Button
              ...
              onClick={() => {
                ...
                const params = new URLSearchParams({
                  ...
                  upstream_request_id: filters?.upstreamRequestId || "",
                });

                // 直接觸發瀏覽器下載後端 API，避免 blob 警告
        ...
        <TooltipContent>{t("導出當前日誌為 Excel")}</TooltipContent>
      </Tooltip>
